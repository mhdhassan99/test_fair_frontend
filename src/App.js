...
import Sofas from './components/category/sofas'
import Sectionals from "./components/category/sectionals";
import CoffeeTables from "./components/category/coffeeTables";
import ChaiseLoungeChairs from "./components/category/coffeeTables";
import TvStands from "./components/category/coffeeTables";
  ...
  render() {
    ...
    return (
      ...
      <Switch>
        ...
        <Route path="/sofas" component={Sofas} user={this.state.user} />
        <Route path="/sectionals" component={Sectionals} user={this.state.user} />
        <Route path="/coffeeTables" component={CoffeeTables} user={this.state.user} />
        <Route path="/chaiseLoungeChairs" component={ChaiseLoungeChairs} user={this.state.user} />
        <Route path="/tvStands" component={TvStands} user={this.state.user} />
      </Switch>
    </div>
    );
  }
